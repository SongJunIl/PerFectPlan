...
#head_bar{height: 130px; width:750px; float:left; background-color: white;  margin-top:20px; margin-left: 80px;  }
...
<input type="hidden" id="ctiy_no" name="city_no" value="${spotDTO.city_no}">
</form>
</div>
</div>
